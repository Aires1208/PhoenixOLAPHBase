...
public class QueryCpuRatioByTimeActionTest {
    @Test
    public void query() throws Exception {

        QueryHisCpuStaticsGroupbyAgentIdAction queryHisCpuStaticsGroupbyAgentIdAction = PowerMockito.mock(QueryHisCpuStaticsGroupbyAgentIdAction.class);
        ESQueryCond queryCond = new ESQueryCond.ESQueryCondBuild().build();
        PowerMockito.when(queryHisCpuStaticsGroupbyAgentIdAction.query(queryCond)).thenReturn(getResult());

        ESQueryResult result = new QueryCpuRatioByTimeAction(queryHisCpuStaticsGroupbyAgentIdAction).query(queryCond);
