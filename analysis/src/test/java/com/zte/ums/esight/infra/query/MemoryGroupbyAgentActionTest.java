...
public class MemoryGroupbyAgentActionTest {
    @Test
    public void getSql() throws Exception {
        ESQueryCond queryCond = new ESQueryCond.ESQueryCondBuild()
                ...
                .to(2L)
                .build();
        String sql = new MemoryGroupbyAgentAction().getSql(queryCond).trim();
    ...
    private String getExpectedSql() {
        return "select AgentId, AgentStartTime\n" +
                ...
                "    group by AgentId, AgentStartTime";
    }
