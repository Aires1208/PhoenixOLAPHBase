...
public class QueryProcessTopNUsageAction extends QueryAction {

    public QueryProcessTopNUsageAction() {
    ...
    public ESQueryResult query(ESQueryCond esQueryCond) {
        ...
        return topNCpuUsage(esMetricses);
    }
    ...
    private ESQueryResult topNCpuUsage(List<ESMetrics> esMetricses) {
