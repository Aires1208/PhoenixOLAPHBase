...
public class QueryProcessTopNCpuTimeAction extends QueryAction {

    private String aggType;

    public QueryProcessTopNCpuTimeAction(String aggType) {
    ...
    public ESQueryResult query(ESQueryCond esQueryCond) {
        List<ESMetrics> esMetricses = new HisProcessByPidAction()
